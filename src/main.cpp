...
unsigned int nStakeMinAge = 60 * 60 * 24* 365  * 9;	
unsigned int nStakeMaxAge = 60 * 60 * 24* 365  * 10;
unsigned int nStakeTargetSpacing = 60;			
unsigned char pchMessageStart[4] = { 0xc4, 0xce, 0x8f, 0x7d};
int64 nChainStartTime = 1521165447;
...
const string strMessageMagic = "MineralChain Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if (nPoWHeight == 1)
       nSubsidy = 210000000 * COIN; //Premin: 10M
     //no pow coin wi1ll be created
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MineralChain
    bool fStrictPayToScriptHash = true; // Always active in MineralChain
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MineralChain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "MineralChain,wish is a great Coin!!";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0xd9844cb02562010c7b460d46863ca24fedbae0d94aa80ac214e427ac1f5e75dd"));
